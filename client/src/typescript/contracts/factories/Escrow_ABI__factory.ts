...
import type { Escrow_ABI, Escrow_ABIInterface } from "../Escrow_ABI";
...
export class Escrow_ABI__factory {
  static readonly abi = _abi;
  static createInterface(): Escrow_ABIInterface {
    return new Interface(_abi) as Escrow_ABIInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): Escrow_ABI {
    return new Contract(address, _abi, runner) as unknown as Escrow_ABI;
  }
}
